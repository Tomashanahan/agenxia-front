  ...
  return (
    <div className="container-form">
      ...
      <h2
        ...
        data-aos-delay="300"
        data-aos-offset="0">
        PARA RECIBIR OFERTAS Y NOTICIAS
      </h2>
      <p
        className="form-p"
        data-aos="fade-zoom-in"
        ...
        data-aos-delay="300"
        data-aos-offset="0">
        Habla con un asesor sobre cuáles son tus objetivos de viaje y ellos comenzarán a construir tus vacaciones
        perfectas de inmediato.
      </p>
