    ...
    return (
        <div className='container-grid-5'>
            <Row className='Row-grid-5'>
                <Col className="R1-C1-5" data-aos="flip-left"
                ...
                <Col className="R1-C2-5" data-aos="flip-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" md={6}>
                    <h1>MÁS EDUCACIÓN</h1>
            ...
            <Row className='Row-grid-5'>
                <Col className="R2-C1-5" data-aos="zoom-in-right"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" md={6}>
                ...
                <Col className="R2-C2-5" data-aos="zoom-in-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" md={6}>
                    <h1>MÁS APOYO</h1>
